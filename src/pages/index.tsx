...
import { Menu, SocialButton, Footer, PodcastCard } from '../components/shared/index';
      ...
      <div className="text-white">
        ...
        <div className="flex flex-col justify-center items-center gap-5">
          <div className="flex flex-col items-center gap-2">
            <span className="text-3xl font-bold">Quem já passou por aqui</span>
            <span className="font-extralight">OUÇA NOSSOS EPISÓDIOS</span>
          </div>
